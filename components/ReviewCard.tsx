    ...
    <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start sm:items-center justify-between mb-2 gap-2">
        <div className="flex items-center gap-0.5 sm:gap-1 flex-shrink-0">
          ...
          <span className="ml-1 sm:ml-2 font-semibold text-gray-900 text-sm sm:text-base">{review.rating}/5</span>
        </div>
        <div className="text-right min-w-0">
          <div className="text-xs sm:text-sm text-gray-500 truncate" title={formatAbsoluteDate(createdAt)}>
